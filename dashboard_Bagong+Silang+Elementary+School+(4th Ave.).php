...
<div class="container">
    <div class="sidebar">
        ...
        <div class="nav-item">
            <a class="nav-link" href="dashboard_Bagong+Silang+Elementary+School+(4th Ave.).php">Batch Records</a>
        </div>
    ...
    <div class="content">
        <h1>Bagong Silang Elementary School (4th ave.)</h1>
