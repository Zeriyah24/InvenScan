...
<div class="container">
    <div class="sidebar">
        ...
        <div class="nav-item">
            <a class="nav-link" href="dashboard_Vicente+Malapitan+Senior+High+School.php">Batch Records</a>
        </div>
        <?php if ($showMainDashboardLink): ?>
          ...
          <?php if ($showMainDashboardLink): ?>
              <div class="nav-item">
                  <a class="nav-link" href="view_school.php">Back</a>
              </div>
            <?php endif; ?>
    </div>
    <div class="content">
        <h1>Vicente Malapitan Senior High School</h1>
