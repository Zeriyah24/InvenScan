...
<div class="container">
    <div class="sidebar">
        ...
        <div class="nav-item">
            <a class="nav-link" href="dashboard_Horacio+Dela+Costa+Elementary+School.php">Batch Records</a>
        </div>
    ...
    <div class="content">
        <h1>Horacio Dela Costa Elementary School</h1>
