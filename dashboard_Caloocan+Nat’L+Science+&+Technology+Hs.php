...
<div class="container">
    <div class="sidebar">
        ...
        <div class="nav-item">
            <a class="nav-link" href="dashboard_Caloocan+Nat’L+Science+&+Technology+Hs.php">Batch Records</a>
        </div>
    ...
    <div class="content">
        <h1>Caloocan Nat'L Science & Technology Hs.</h1>
