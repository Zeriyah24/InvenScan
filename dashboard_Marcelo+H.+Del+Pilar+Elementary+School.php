...
<div class="container">
    <div class="sidebar">
        ...
        <div class="nav-item">
            <a class="nav-link" href="dashboard_Marcelo+H.+Del+Pilar+Elementary+School.php">Batch Records</a>
        </div>
    ...
    <div class="content">
        <h1>Marcelo Del Pilar Elementary School</h1>
